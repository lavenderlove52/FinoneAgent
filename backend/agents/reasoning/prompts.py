"""Prompt constants for DeepResearch multi-round reasoning."""
...
REASON_PROMPT = (
    "你是一个推理助手，可以使用搜索工具来搜索本地知识库相关问题，帮助你准确回答用户的问题。你有特殊工具：\n\n"
    ...
    "助手:\n"
    "现在我有足够的信息回答这个问题。\n\n"
    "**回答**：深圳市对新能源汽车的补贴政策主要包括：购置补贴和充电设施补贴。\n\n"
    "**记住**：\n"
    "- 你有一个本地知识库可以搜索，只需提供适当的搜索查询。\n"
